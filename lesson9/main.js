...
document.body.appendChild(ulData);
for (const item of data) {
    let dataBlocks = document.createElement('li');
    dataBlocks.innerText = item;
    ulData.appendChild(dataBlocks);
}
...
for (const element of coursesAndDurationArray) {
    let coursesBlock = document.createElement('h4');
    coursesBlock.innerText = `${element.title} - ${element.monthDuration}`;
...
for (const element of coursesAndDurationArray1) {
    let coursesBlock1 = document.createElement('div');
    coursesBlock1.classList.add('item');
    ...
    coursesBlock1.append(title, p);
    document.body.appendChild(coursesBlock1);
}
...
for (const element of simpsons) {
    ...
    li.innerText = `${element.name} ${element.surname}, age - ${element.age}`;

    let info = document.createElement('p');
    info.innerText = element.info;

    memberInfo.append(li, img, info);
    simpsonsBlock.append(memberInfo);
    document.body.appendChild(simpsonsBlock);
}
document.body.appendChild(hr.cloneNode());
// =========================
//     Цикл в циклі
...
for (const element of coursesArray) {
    ...
    let modulesBlock = document.createElement('ol');
    modulesBlock.classList.add('modulesBlock');




    for (const Element of element.modules) {
        let courseModule = document.createElement('li');
        courseModule.classList.add('courseModule');
        courseModule.innerText = Element;
        modulesBlock.appendChild(courseModule);
    }


    duration.append(month, hour);
    coursesBlock.append(title, duration, modulesBlock);
    document.body.appendChild(coursesBlock);
}
